...
var resizePizzas = function(size) {
    ...
    // This helped in reducing the time taken for resizing the pizzas while sliding
    ...
    function changePizzaSizes(size) {
        ...
        // Declaring the variable randomPizzas outside the for loop so as to reduce the scripting time taken
...
// Declaring the variable pizzasDiv outside the function so as to reduce the scripting time taken
...
document.addEventListener('DOMContentLoaded', function() {
    var cols = 8;
    var s = 256;
    //Reducing the limit value from 200 to 24 resulted in reduction of average scripting time while scrolling
    var elem;
    for (var i = 0; i < 24; i++) {
